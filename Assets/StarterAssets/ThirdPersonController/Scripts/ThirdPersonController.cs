...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Move()
        {
            ...
            {
                // Gradually increase speed toward SprintSpeed while holding movement
                _speed = Mathf.MoveTowards(_speed, SprintSpeed, SpeedChangeRate * Time.deltaTime);
                targetSpeed = _speed;
            }
            else
            {
                // Reset speed instantly when stopping
                _speed = MoveSpeed;
                targetSpeed = 0.0f;
            }
            ...
            Vector3 inputDirection = flatCameraForward * _input.move.y + flatCameraRight * _input.move.x;
